...
| `instatic-editor-layout-v2`                     | Per-workspace sidebar widths, open states, Site Explorer tab and Components / HTML Layers view, plus floating panel positions | `src/admin/state/workspaceLayoutStorage.ts` → `EDITOR_LAYOUT_STORAGE_KEY` |
