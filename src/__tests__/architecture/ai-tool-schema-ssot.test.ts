...
const EXPECTED_SCHEMA_BY_TOOL = {
  ...
  site_list_component_library: ListComponentLibraryInputSchema,
  site_check_accessibility: CheckComponentLibraryAccessibilityInputSchema,
  site_insert_component: InsertComponentLibraryEntryInputSchema,
  site_consolidate_rich_text: ConsolidateRichTextInputSchema,
  site_update_component_field: UpdateComponentLibraryFieldInputSchema,
  site_apply_component_option: ApplyComponentLibraryOptionInputSchema,
