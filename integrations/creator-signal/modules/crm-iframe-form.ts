...
export default defineModule({
  ...
  render: ({ props }) => {
    ...
    if (!origin) {
      return {
        html: html`<section class="cs-crm-iframe-form-shell" id="${escapedProp(props.sectionId)}" role="status">${escapedProp(props.unavailableMessage)}</section>`,
        css,
      }
    }
    ...
    return {
      html: html`
        <section class="cs-crm-iframe-form-shell" id="${escapedProp(props.sectionId)}" data-cs-crm-iframe-form
