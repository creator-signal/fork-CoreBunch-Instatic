...
/** Normalize a render()/preview() return into the host render-output wire shape. */
function normalizeRenderOutput(out: unknown): {
  html: string
  css?: string
  js?: string
  cspSources?: unknown[]
  ...
  return {
    ...
    cspSources: o && typeof o === 'object' && Array.isArray(o.cspSources)
      ? o.cspSources
      : undefined,
  }
}
