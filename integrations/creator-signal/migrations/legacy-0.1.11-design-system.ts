/**
 * Frozen Creator Signal 0.1.11 public-site design system.
 *
 * This snapshot exists only so the guarded authored-content classifier can
 * recognise the exact historic starter pages. New runtime code must consume
 * ../design-system/lock.json through the current pack adapter instead.
 */
